...
import { YouTubeIFrameApi, YouTubeNumericPlayerError, YouTubeNumericPlayerState, YouTubePlayer, YouTubePlayerQualitySetting } from "./youtube-api";
export declare abstract class YouTubeIFrameApiService {
    abstract api: YouTubeIFrameApi | undefined;
    abstract apiChange: Observable<YouTubeIFrameApi | undefined>;
}
export declare abstract class YouTubePlayerManagerService {
