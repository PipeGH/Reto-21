...
class YouTubePlayerComponent {
    ...
    set list(newList) {
        ...
        if (newList && this.listType) {
            (_a = this.player) === null || _a === void 0 ? void 0 : _a.loadPlaylist({
                list: newList,
    ...
    set loop(newLoop) {
        var _a;
        this._loop = newLoop;
        (_a = this.player) === null || _a === void 0 ? void 0 : _a.setLoop(newLoop);
    }
    get modestbranding() {
    ...
    set height(newHeight) {
        ...
        (_a = this.player) === null || _a === void 0 ? void 0 : _a.setSize(this.width, this.height);
    }
    get width() {
        return this._width;
    }
    ...
    set videoId(newVideoId) {
        ...
        (_a = this.player) === null || _a === void 0 ? void 0 : _a.loadVideoById(this.videoId, this.start);
    }
    get api() {
    ...
    setupPlayerWith(elementId, config) {
        const subscription = this.iFrameApi.apiChange.subscribe((api) => {
            ...
            const player = new api.Player(elementId, Object.assign(Object.assign({}, config), { events: {
                    onReady: () => {
                        this.player = player;
...
class StandardYouTubePlayerManagerService extends YouTubePlayerManagerService {
    ...
    add(id, data) {
        ...
        const rejoinedData = Object.assign({ id }, data);
