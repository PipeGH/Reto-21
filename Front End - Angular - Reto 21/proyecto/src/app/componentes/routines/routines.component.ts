...
export class RoutinesComponent implements OnInit {
  ...
  goToEditRoutine(id_plan_entrenamiento:any){
    const swalWithBootstrapButtons = Swal.mixin({
      customClass: {
        confirmButton: 'btn btn-success',
        cancelButton: 'btn btn-danger'
    ...
    swalWithBootstrapButtons.fire({
      ...
      text: "Esta seguro que desea actualizar el plan de entrenamiento?",
      icon: 'warning',
      showCancelButton: true,
      ...
      if (result.isConfirmed) {
          ...
          Swal.fire({
            icon: 'success',
            text: 'Acontinuacion podras editar el plan de entrenamiento'
          }).then(Response =>{this.router.navigateByUrl('record-routine/'+id_plan_entrenamiento)})
