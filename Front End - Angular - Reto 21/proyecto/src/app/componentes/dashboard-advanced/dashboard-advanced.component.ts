...
export class DashboardAdvancedComponent implements OnInit {
  ...
  constructor(
    ...
    if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) {
      ...
      this.state_deploy_Graphips = 'movil';

    }else if(navigator.userAgent.match(/Windows/i) || navigator.userAgent.match(/Linux/i) ){

      this.state_deploy_Graphips = 'pc';
  ...
  updateData(){
    ...
    this.service.selecGeneralesAdvanced(form).subscribe(res => {
      ...
      for(let x of this.listGenerales){
        ...
        this.chartLabels = [...this.chartLabels, x.fecha.substring(0,10)];
...
SearchTypeGrapich(id:any){
  if(id==1){
    this.grafica="primera";
}else if(id==2){
  this.grafica="segunda";
}else if(id==3){
  this.grafica="tercera";
}else if(id==4){
  this.grafica="cuarta";
}else if(id==5){
  this.grafica="quinta";
