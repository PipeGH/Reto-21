...
export class AppComponent {
  ...
  constructor(
    ...
    if(localStorage.getItem('temp_unload') != null){



      const temp_unload:any = localStorage.getItem('temp_unload');
      ...
      if(temp_unload == 0){
        ...
        Swal.fire({
          ...
          text: 'Hemos cerrado tú sesión por abandono de pestaña, Ingresa nuevamente.'
          ...
          localStorage.removeItem('temp_unload');
